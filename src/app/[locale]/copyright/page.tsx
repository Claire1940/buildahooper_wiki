...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Build a Hooper Wiki',
    description: 'Copyright and intellectual property information for Build a Hooper Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Build a Hooper Wiki',
      description: 'Copyright and intellectual property information for Build a Hooper Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Build a Hooper Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Build a Hooper Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Build a Hooper Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Build a Hooper developers</strong> - Creators of the Build a Hooper game</li>
            </ul>
            <p>
            ...
            <p>
              ...
              affiliation with Build a Hooper Wiki.
            </p>
            ...
            <p>
              ...
              Build a Hooper Wiki<br />
              Email: <a href="mailto:dmca@buildahooper.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildahooper.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Build a Hooper Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Build a Hooper Wiki (buildahooper.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@buildahooper.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@buildahooper.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@buildahooper.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@buildahooper.wiki</a>
            </p>
            <p>
